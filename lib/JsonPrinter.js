...
/**
 * Construct a JsonPrinter that reads the provided instance of tap-parser.
 *
...
function JsonPrinter (tapParser, options) {
    TapReceiver.call(this, tapParser);
    options = options || {};
    this._tabSize = options.tabSize || 0;
    this._truncateStackAtPath = options.truncateStackAtPath || null;
    this._writeFunc = options.writeFunc || function(text) {
