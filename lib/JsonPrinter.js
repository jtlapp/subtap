...
// _truncateTraceAtPath - call path at which to truncate call stacks
...
function JsonPrinter (outputStream, printerOptions, inputStreamOptions) {
    ...
    this._truncateTraceAtPath = printerOptions.truncateTraceAtPath || null;
...
JsonPrinter.prototype.abort = function () {
    TapReceiver.prototype.abort.call(this);
    this._endJson();
};
