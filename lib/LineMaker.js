...
LineMaker.prototype.colorWrap = function (styleID, text, width) {
    if (this._styleMode <= LineMaker.STYLE_MONOCHROME)
        styleID = null;
    return this._wrap(styleID, text, width);
};
...
LineMaker.prototype.styleWrap = function (styleID, text, width) {
    if (this._styleMode === LineMaker.STYLE_OFF)
        styleID = null;
    return this._wrap(styleID, text, width);
};
...
LineMaker.prototype._wrap = function (styleID, text, width) {
