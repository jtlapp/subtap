...
LineMaker.prototype.colorWrap = function (styleID, text, width, firstIndent) {
    if (this._styleMode <= LineMaker.STYLE_MONOCHROME)
        styleID = null;
    return this._wrap(styleID, text, width, firstIndent);
};
...
LineMaker.prototype.styleWrap = function (styleID, text, width, firstIndent) {
    if (this._styleMode === LineMaker.STYLE_OFF)
        styleID = null;
    return this._wrap(styleID, text, width, firstIndent);
};
...
LineMaker.prototype._wrap = function (styleID, text, width, firstIndent) {
...
LineMaker.prototype._wrapLineAtMargin = function (line, width) {
    ...
    if (remainder.length === 0)
        ...
        remainder = CONTINUED_CHAR + carryOverEsc + remainder;
