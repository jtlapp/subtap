...
blankLine();
line("Subtap numbers the root subtests and outputs test results in one of several formats. A \"root subtest\" is a test whose parent is the root test. The following options select the output format. 'tally' is the default, inspired by the 'faucet' command for the 'tape' test harness.");
blankLine();
var group = [];
